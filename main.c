...
int main(void)
{
    ...
    case 1:
        ...
        break;
    case 2:
        puts("1.Squareroot 2.Square 3.Any power of any number 4.Any root of any number");
        scanf("%d", &operator);
        break;
    case 3:
    ...
    case 4:
        ...
        break;
    case 5:
        puts("1.Celsius to Fahrenheit 2.Fahrenheit to Celsius 3.KM to mile 4.Mile to KM");
        scanf("%d", &operator);
        break;
    default:
        puts("Invalid input.");
...
void operations(int operation, int operator)
{
    ...
    else if (operation == 2)
    {
        ...
        else if (operator== 4)
        {
            ...
            puts("Enter root");
            scanf("%d", &root);
            result = rootofany(num, root) - 0.01;
            printf("%0.2f", result);
        }
        else
        {
    ...
    else if (operation == 5)
    {
        ...
        else if(operator==3) 
        {
            scanf("%f",&KM);
            mile=KM_to_Mile(KM);
            printf("%f km is %f mile", KM,mile);
        }
        else if(operator==4) 
        {
            scanf("%f",&mile);
            KM=Mile_to_KM(mile);
            printf("%f mile is %f km", mile,KM);
        }
        else
        {
            puts("Invalid input");
